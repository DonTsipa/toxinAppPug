...
(function (root, factory) {
    ...
    {
        return '<button type="button" class="material-icons lightpick__previous-action">' + opts.locale.buttons.prev + '</button>'
            + '<button type="button" class="material-icons lightpick__next-action">' + opts.locale.buttons.next + '</button>'
    ...
    renderYearsList = function(date, opts)
    {
        var d = moment(date),
            ...
            minYear = years && years.min ? years.min : date.toDate().getFullYear(),
